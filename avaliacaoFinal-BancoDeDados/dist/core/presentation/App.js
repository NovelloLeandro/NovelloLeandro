...
const HeavyRoutes_1 = __importDefault(require("../../features/heavys/routers/HeavyRoutes"));
class App {
    constructor() {
    ...
    routes() {
        ...
        const heavyRoutes = new HeavyRoutes_1.default().init();
        __classPrivateFieldGet(this, _App_express, "f").use(userRoutes);
        __classPrivateFieldGet(this, _App_express, "f").use(heavyRoutes);
        __classPrivateFieldGet(this, _App_express, "f").use(express_1.default.static('public'));
    }
    start(port) {
